...
class CoreEngine(BaseOptimizedEngine):
    ...
    def process_file_strategy_combination(self, data_file: Path, strategy_file: Path) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            # Run backtest using the strategy class directly
    ...
    def run(self):
        ...
        self.logger.info(f"Processing {total_combinations} combinations...")
        ...
        for i, data_file in enumerate(data_files):
            for j, strategy_file in enumerate(strategy_files):
                ...
                try:
                    results = self.process_file_strategy_combination(data_file, strategy_file)
